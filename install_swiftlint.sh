...
function create_couch_db_databases {
  ...
  echo "curl -X POST -H 'Content-Type: application/json' -d '{\"_id\":\"qwertyuiop\",\"list\":[{\"_id\":\"abc\",\"username\":\"qwerty\",\"email\":\"qwerty@email.com\"}]} 127.0.0.1:5984/test_add_change'"
  eval "curl -X POST -H 'Content-Type: application/json' -d '{\"_id\":\"qwertyuiop\",\"list\":[{\"_id\":\"abc\",\"username\":\"qwerty\",\"email\":\"qwerty@email.com\"}]}' 127.0.0.1:5984/test_add_change"
